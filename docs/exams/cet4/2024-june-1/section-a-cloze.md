...
type: "cloze"
part: "section-a"
title: "CET-4 2024-june-1 Section A Cloze"
sectionId: "cet4-2024-june-1-section-a-cloze"
interactive: true
---
# CET-4 2024-june-1 Section A Cloze
...
answers:
  ...
  "35": "J"
explanations:
  "26": "解析：此处需要形容词修饰guidelines（指南），结合语境“大多数国家有XXX、有证据支持的指南”，detailed（详细的）符合语义，故选D。"
  "27": "解析：此处为后置定语修饰exercise，exercise与require（要求）是被动关系，用required表示“（获得健康益处）所需的运动”，故选M。"
  "28": "解析：此处需要副词修饰due to，partly（部分地）符合语境“这部分是由于缺乏必要的证据”，故选L。"
  "29": "解析：dip into为固定搭配，意为“深入研究、探讨”，before是介词，后接动名词dipping，故选F。"
  "30": "解析：根据后文“between aerobic exercise and anaerobic”（有氧运动和无氧运动之间），可知是二者的区别，distinction（区别、差异）符合语义，故选G。"
  "31": "解析：此处需要动词作谓语，主语the former（前者，指有氧运动）与involves（包含、涉及）搭配，意为“有氧运动包括散步、慢跑和骑行等”，故选I。"
  "32": "解析：根据后文“your body does not have time to use oxygen to create energy”（身体没时间用氧气产生能量），可知无氧运动强度很高，vigorous（高强度的、剧烈的）符合语义，故选O。"
  "33": "解析：根据后文“Some favoured higher intensity, others low”（一些支持高强度，一些支持低强度），可知研究结果是矛盾的，contradictory（矛盾的、对立的）符合语义，故选B。"
  "34": "解析：make no difference to为固定搭配，意为“对……没有影响”，此处表示“强度对情绪益处没有影响”，故选E。"
  "35": "解析：根据后文“low intensity is too dull while high intensity is too unpleasant”（低强度太无聊，高强度太令人不适），可知最佳的是中等强度，moderate（适度的、中等的）符合语义，故选J。"
```
