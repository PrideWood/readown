...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2023-june-2 Section C Reading 2"
sectionId: "cet6-2023-june-2-section-c-reading-2"
interactive: true
---
# CET-6 2023-june-2 Section C Reading 2
...
questions:
  - id: "51"
    prompt: "Why are many people opposed to monitoring employee performance?"
    options:
    ...
    answer: "A"
    explanation: "The author states people oppose it because of its \"inherent dehumanizing effect\" and \"relentless pressure\"."

  - id: "52"
    prompt: "What is the supporters’ argument for workplace surveillance?"
    options:
    ...
    answer: "D"
    explanation: "Supporters argue surveillance can protect employees from bullying and sexual harassment (aggressive behavior)."

  - id: "53"
    prompt: "What does the author want to show by the example of different numbers of people interacting at lunch tables?"
    options:
    ...
    answer: "B"
    explanation: "The example illustrates that data analysis can produce \"unexpected results\" (12-person tables lead to better interaction and performance)."

  - id: "54"
    prompt: "What does much of the positive effect of monitoring initiatives depend on?"
    options:
    ...
    answer: "D"
    explanation: "The author emphasizes that transparency in communication (bosses being open about data collection and use) determines employee acceptance and positive outcomes."

  - id: "55"
    prompt: "What concern do monitoring initiatives cause among many staffers?"
    options:
    ...
    answer: "C"
    explanation: "Many employees fear monitoring will lead to \"erosion of their civil liberties\" (infringement on their freedom and rights)."
```
