...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2022-dec-3 Section C Reading 2"
sectionId: "cet6-2022-dec-3-section-c-reading-2"
interactive: true
---
# CET-6 2022-dec-3 Section C Reading 2
...
questions:
  - id: "51"
    prompt: "What do we learn from the passage about an enzyme scientists have created?"
    options:
    ...
    answer: "B"
    explanation: "The passage states the enzyme breakthrough \"could help solve the global plastic pollution crisis by enabling for the first time the full recycling of bottles,\" meaning it may make full recycling of plastic bottles possible (option B). Option A misrepresents the accident—they adjusted an existing enzyme and accidentally improved it, not identified it by accident; Options C and D are not supported."

  - id: "52"
    prompt: "What does the passage say about the bug that produces the important enzyme?"
    options:
    ...
    answer: "A"
    explanation: "The bug is a bacterium that \"naturally evolved to eat plastic,\" meaning it has a natural ability to consume plastics (option A). Option B is not mentioned; Option C is an overstatement; Option D is incorrect, as scientists revealed its detailed structure."

  - id: "53"
    prompt: "By adjusting the enzyme produced by the bug, the scientists __________."
    options:
    ...
    answer: "A"
    explanation: "The scientists adjusted the enzyme to study its evolution, but \"accidentally made the molecule even better at breaking down the plastic,\" meaning they made it more effective by chance (option A). Options B, C, D are not supported by the text."

  - id: "54"
    prompt: "What does Prof. McGeehan say about the recycling of plastic bottles?"
    options:
    ...
    answer: "D"
    explanation: "Prof. McGeehan notes that public perception is changing, so \"companies are starting to look at how they can properly recycle these bottles,\" meaning manufacturers are beginning to explore recycling methods (option D). Options A, B, C are not supported by his statement."

  - id: "55"
    prompt: "What is Prof. Adisa Azapagic’s advice concerning the application of the enzyme?"
    options:
    ...
    answer: "C"
    explanation: "Prof. Azapagic advises a \"full life-cycle assessment\" to ensure the technology does not solve one environmental problem at the expense of others (like greenhouse gas emissions), meaning assessing its possible negative environmental impact (option C). Option D misinterprets \"full life-cycle assessment\" as studying the enzyme’s life cycle; Options A and B are not mentioned."
```
