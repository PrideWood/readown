...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2022-june-2 Section C Reading 2"
sectionId: "cet6-2022-june-2-section-c-reading-2"
interactive: true
---
# CET-6 2022-june-2 Section C Reading 2
...
passage: |-
  ...
  It is equally imperative to emphasize that being an expert on a topic does not automatically make a scholar qualified to communicate it to a nonscientific audience. A number of scientists recently have been offering public explanations of scientific phenomena. Even though they have appropriate credentials, they often do very little in the way of explaining. One biologist shared an intricate analogy involving a library, books, paper, a recipe, ingredients, and a cake to explain the process behind vaccines. Any explanation that requires a written key to keep track of what each item represents is not a clear example for public consumption.
...
questions:
  - id: "51"
    prompt: "What does the author say about communicating science to the general public?"
    options:
    ...
    answer: "B"
    explanation: "The author states that communicating science beyond academia is \"necessary to augmenting public understanding of health and environmental issues,\" which aligns with option B. Options A, C, D are not mentioned as the purpose of science communication."

  - id: "52"
    prompt: "What does the author advise scientists do to deal with topics outside of their specialty?"
    options:
    ...
    answer: "C"
    explanation: "The author advises that scientists \"consult with an expert if the topic is outside of their discipline,\" meaning they should seek professional help from a specialist (option C). Option D is incorrect because it specifies \"colleagues in their field,\" not the relevant specialist."

  - id: "53"
    prompt: "What does the author say we can learn from social media?"
    options:
    ...
    answer: "D"
    explanation: "The author refutes the claim that the public cannot understand science, noting that social media shows the public \"craves knowledge based on a solid scientific foundation\" and can understand even complex principles, indicating their understanding is better than some claim (option D). Options A, B, C are not supported by the text."

  - id: "54"
    prompt: "What does the example of the biologist who shared an intricate analogy show?"
    options:
    ...
    answer: "C"
    explanation: "The example illustrates that even a credentialed expert (biologist) can fail to communicate science clearly to the public, showing that expertise does not equal communication skill (option C). Option A is the opposite of the example’s point; Option D is refuted by the author; Option B is irrelevant."

  - id: "55"
    prompt: "What does the author suggest scientists do to close the gap between science and society?"
    options:
    ...
    answer: "D"
    explanation: "The author recommends that scientists \"take communication courses\" to learn to eliminate jargon and use effective analogies, which are core communication skills (option D). Option C is too narrow; public speaking is only part of communication. Options A and B are incorrect, as the author advocates simplifying, not using more scientific language."
```
