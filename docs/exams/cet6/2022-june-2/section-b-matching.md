...
statements:
  - id: "36"
    text: "Climate change has wrought havoc on the lives of tens of thousands of people."
  - id: "37"
    text: "It took scientists a long time to realise that the function of forests goes far beyond providing humans with timber."
  - id: "38"
    text: "There is abundant evidence that we are now facing a possible ecological disaster."
  - id: "39"
    text: "Environmental science became academic disciplines only some sixty years ago."
  - id: "40"
    text: "Things cannot change overnight, but reducing the consumption of natural resources will help solve the ecological crisis."
  - id: "41"
    text: "Human perception of forests has undergone a tremendous change in the past years."
  - id: "42"
    text: "Recent history shows reduction of pollution, once seemingly impossible, can actually be accomplished."
  - id: "43"
    text: "People began to consider preserving natural resources when they feared they would have nothing to use in the future."
  - id: "44"
    text: "If we doubt our ability to reverse ecological deterioration, we are throwing away the chance to take action."
  - id: "45"
    text: "How to respond effectively to climate change has become the focus of international diplomacy."
answers:
  "36": "F"
  "37": "B"
  "38": "H"
  ...
  "45": "E"
explanation:
  "36": "Paragraph F states “climate change has already destroyed tens of thousands of livelihoods,” which matches the statement."
  "37": "Paragraph B says “It would take more than three centuries before scientists began to understand that timber production is not the only, and possibly not the most important, function of forests,” matching the statement."
  "38": "Paragraph H states “Scientific evidence that we are living in an era of climate change, resource exhaustion and potential ecological disaster is overwhelming,” matching the statement."
  "39": "Paragraph D notes the first bachelor of science in environmental studies was awarded in 1956, which is about 60+ years ago, matching the statement."
  "40": "Paragraph K says “we can’t expect things to change overnight… cutting down on exhaustive practices and working towards a ‘stretching of the present’ will be ways to move forward,” matching the statement."
  "41": "Paragraph C states “Recent years have seen a big change in our view of forests,” matching the statement."
  "42": "Paragraph G details how London reduced severe air pollution from the 1950s to today, proving pollution reduction is possible, matching the statement."
  "43": "Paragraph A says “The idea of preserving resources came out of a concern for the future: a fear of using up resources faster than they could be replenished,” matching the statement."
  "44": "Paragraph J states “if we believe that nothing can be changed, then we are giving up our opportunity to act,” matching the statement."
  "45": "Paragraph E says “The search for an adequate response to climate change occupies centre stage in international diplomacy,” matching the statement."
```
