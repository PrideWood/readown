...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2024-dec-1 Section C Reading 1"
sectionId: "cet6-2024-dec-1-section-c-reading-1"
interactive: true
---
# CET-6 2024-dec-1 Section C Reading 1
...
questions:
  - id: "46"
    prompt: "The alien finds the audience in the movie theatre clearly in a state of"
    options:
      A: "total mindfulness"
      ...
      D: "intense curiosity"
    answer: "B"
    explanation: "The alien observes the audience is in “a state of high arousal” with elevated heart rate, nervous glances, and collective jumps. This matches “extreme excitement” in option B."

  - id: "47"
    prompt: "Why do many people seek out scary entertainment, according to the author’s research?"
    options:
    ...
    answer: "B"
    explanation: "The author states humans evolved to find pleasure in “situations that allow us to experience negative emotions in a safe context,” and horror is such a simulated horrible experience. This matches option B."

  - id: "48"
    prompt: "What do children learn from hide-and-seek?"
    options:
    ...
    answer: "A"
    explanation: "The passage says hide-and-seek “gives the child crucial information about how to avoid becoming prey,” which directly matches “avoid falling prey to an attacker” in option A."

  - id: "49"
    prompt: "Why is horror gratifying to many people?"
    options:
    ...
    answer: "C"
    explanation: "The author explains horror is pleasurable “because it lets us play with negative emotions and develop coping strategies. We learn what it feels like to be truly afraid, and we learn how to handle negative emotion.” This matches option C."

  - id: "50"
    prompt: "What will one experience if they watch a horror film through without being hurt?"
    options:
    ...
    answer: "D"
    explanation: "The passage states that if you make it through the film unharmed, you’ll feel “a strong sense of mastery, a sense that you were able to make it through an appalling experience.” “Sense of mastery” matches “strong sense of being in control” in option D."
```
