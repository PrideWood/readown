...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2022-sept-1 Section C Reading 1"
sectionId: "cet6-2022-sept-1-section-c-reading-1"
interactive: true
---
# CET-6 2022-sept-1 Section C Reading 1
...
questions:
  - id: "46"
    prompt: "What does the author say is the issue all major economic powers have to address?"
    options:
    ...
    answer: "D"
    explanation: "The author states that all major economic powers agree that tech companies are too big, too powerful, and too profitable, and governments must confront this by taking anti-trust measures to rein in their monopoly power (option D). Option C is a possible measure, not the core issue to address; Options A and B are the opposite of the author’s point."

  - id: "47"
    prompt: "What does the suspension of Ant Group Co.’s stock offering suggest?"
    options:
    ...
    answer: "C"
    explanation: "The suspension of Ant Group’s stock offering is cited to show that \"no company can evade the government’s regulation,\" meaning all companies are subject to government regulation (option C). Option A is an overstatement; Options B and D are not supported by the text."

  - id: "48"
    prompt: "How are smaller companies impacted by tech giants’ business expansion?"
    options:
    ...
    answer: "A"
    explanation: "The text states that tech giants force smaller businesses to \"rely on their platforms to reach customers,\" meaning smaller companies can no longer operate independently of tech giants (option A). Options B, C, D are not mentioned in the passage."

  - id: "49"
    prompt: "What have EU countries done to confront the power of digital giants?"
    options:
    ...
    answer: "B"
    explanation: "The EU, led by Margrethe Vestager, has sought to \"police the market and encourage fair play,\" which means taking regulatory action to promote fair competition (option B). Option A is not the core action; Option C is not mentioned; Option D is a U.S. concern, not the EU’s primary action described."

  - id: "50"
    prompt: "What do Americans generally think of social media companies according to the author?"
    options:
    ...
    answer: "C"
    explanation: "The author notes that the American public is \"increasingly skeptical of social media companies,\" with over 60% saying the sector has a negative effect, indicating they are seen as untrustworthy (option C). Options A, B, D are not directly supported by the cited Pew Research Center data."
```
