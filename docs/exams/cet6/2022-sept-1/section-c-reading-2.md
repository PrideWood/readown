...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2022-sept-1 Section C Reading 2"
sectionId: "cet6-2022-sept-1-section-c-reading-2"
interactive: true
---
# CET-6 2022-sept-1 Section C Reading 2
...
questions:
  - id: "51"
    prompt: "What is the popular assumption about international tourism?"
    options:
    ...
    answer: "D"
    explanation: "The passage states that tourism is \"portrayed as an economic motor for destination countries and cities\" and that there is a tendency to assume it is good for everyone, which aligns with the assumption that it contributes to the economy of destinations (option D). Options A, B, C are not mentioned as the popular assumption."

  - id: "52"
    prompt: "What do we learn from some studies about uncontrolled tourism development?"
    options:
    ...
    answer: "B"
    explanation: "The passage notes that uncontrolled tourism development leads to \"many negative social impacts of tourism and resulting resentment that local populations direct toward visitors,\" and that antagonism toward tourists develops in heavily visited destinations (option B). Options A, C, D are not supported by the studies mentioned."

  - id: "53"
    prompt: "Why does the author say local residents of popular destinations often feel frustrated?"
    options:
    ...
    answer: "D"
    explanation: "The author states that residents become frustrated \"when the benefits of tourism are not felt locally,\" as multinational chains may not allocate benefits equitably, leaving locals with little opportunity to benefit (option D). Options A, B, C are not the direct cause of their frustration."

  - id: "54"
    prompt: "How does the author say local residents in destination communities respond to tourism activity?"
    options:
    ...
    answer: "A"
    explanation: "The passage mentions that local residents \"adopt the behaviors of tourists\" and negotiate \"lifestyle transformations,\" indicating they endeavor to adapt to it (option A)."

  - id: "55"
    prompt: "What can tourists do to exert more positive impacts on the tourist destinations?"
    options:
    ...
    answer: "C"
    explanation: "The author advises informed travelers to distinguish between multinational companies and local entrepreneurs whose businesses benefit local residents, and to reward such local businesses by choosing their services (option C). Options A, B, D are not mentioned as effective ways to create positive impacts."
```
