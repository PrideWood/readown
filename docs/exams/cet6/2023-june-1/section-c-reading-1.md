...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2023-june-1 Section C Reading 1"
sectionId: "cet6-2023-june-1-section-c-reading-1"
interactive: true
---
# CET-6 2023-june-1 Section C Reading 1
...
questions:
  - id: "46"
    prompt: "What do we learn about the deeper implications of AI?"
    options:
    ...
    answer: "D"
    explanation: "The opening paragraph states AI is \"altering humanity,\" and deeper implications center on changing what it means to be human."

  - id: "47"
    prompt: "What is the consequence of algorithmic prescription replacing human judgment?"
    options:
    ...
    answer: "A"
    explanation: "Replacing human judgment with algorithms removes the opportunity to practice and develop practical judgment, as Aristotle emphasized."

  - id: "48"
    prompt: "What may result from increasing application of recommendation engines in our consumption of culture?"
    options:
    ...
    answer: "A"
    explanation: "Recommendation engines constrain choices by optimizing past preferences, limiting consumer options in unanticipated ways."

  - id: "49"
    prompt: "What is likely to happen to larger parts of our daily life as machine learning algorithms improve?"
    options:
    ...
    answer: "C"
    explanation: "Improved algorithms will make larger areas of daily life \"utterly predictable,\" meaning they can be completely anticipated."

  - id: "50"
    prompt: "Why does the author say the creatures living in the more and more AI-mediated world will become increasingly unlike us?"
    options:
    ...
    answer: "B"
    explanation: "Unpredictability is a core part of human self-understanding; as AI makes life predictable, people lose this trait and become less human."
```
