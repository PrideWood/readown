...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2023-june-1 Section C Reading 2"
sectionId: "cet6-2023-june-1-section-c-reading-2"
interactive: true
---
# CET-6 2023-june-1 Section C Reading 2
...
questions:
  - id: "51"
    prompt: "What do we learn about phonics in many American classrooms?"
    options:
      A: "It is ill reputed."
    ...
    answer: "A"
    explanation: "Phonics is called a \"dirty word\" in many classrooms, and teachers have to sneak in phonics materials, indicating it has a bad reputation."

  - id: "52"
    prompt: "What has America been witnessing for decades?"
    options:
    ...
    answer: "B"
    explanation: "America has been stuck in a decades-long debate over how to teach children to read, between phonics and whole-language approaches."

  - id: "53"
    prompt: "Why does Tenette Smith think a combination of teaching methods is ineffective?"
    options:
    ...
    answer: "B"
    explanation: "Smith states that phonics must be \"systematic and explicitly taught\" to work, so a partial mix is ineffective."

  - id: "54"
    prompt: "What does the author say Mississippi’s success is attributed to?"
    options:
    ...
    answer: "C"
    explanation: "Mississippi’s success comes from implementing reading methods based on \"the science of reading,\" i.e., scientifically grounded approaches."

  - id: "55"
    prompt: "What have advances in statistics and brain imaging proved ineffective?"
    options:
    ...
    answer: "D"
    explanation: "Advances in statistics and brain imaging have disproven the whole-language (immersive) method, proving it ineffective."
```
