...
type: "matching"
part: "section-b"
title: "CET-6 2023-june-1 Section B Matching"
sectionId: "cet6-2023-june-1-section-b-matching"
interactive: true
---
# CET-6 2023-june-1 Section B Matching
...
paragraphs:
  ...
  - label: E
    text: >-
      Gratitude has long enjoyed a privileged position in many of the world’s cultural traditions. For example, some ancient Western philosophers counsel gratitude that is both enduring and complete, and some Eastern thinkers portray it as not merely an attitude but a virtue to be put into practice.
  - label: F
    text: >-
...
statements:
  - id: "36"
    text: "It does us far more good to focus on things we can be grateful for than what makes us sad and resentful."
  - id: "37"
    text: "The beneficial impacts of gratitude can extend from individuals to their community and to the wider society."
  - id: "38"
    text: "The participants in a recent study repeatedly underestimated the positive effect on those who received thank-you notes."
  - id: "39"
    text: "Good deeds can sometimes make people feel uncomfortable."
  - id: "40"
    text: "People who regularly express gratitude can benefit in moral terms."
  - id: "41"
    text: "A basketball coach advocated performing generous acts without expecting anything in return."
  - id: "42"
    text: "More and more evidence shows it makes us mentally and physically healthier to routinely count our blessings."
  - id: "43"
    text: "Of all states of mind, feeling grateful is considered one of the most healthy and beneficial."
  - id: "44"
    text: "The principles underlying the research into gratitude are nothing new at all."
  - id: "45"
    text: "Gratitude is likely to enhance one’s sense of being connected with other people."
answers:
  "36": "C"
  "37": "G"
  "38": "A"
  ...
  "45": "H"
explanation:
  "36": "Paragraph C clearly states that it is far more helpful to focus on things we can express gratitude for than those that incline us toward resentment and lamentation, which matches the statement."
  "37": "Paragraph G explains that gratitude promotes virtuous cycles in relationships, makes communities more pleasant, and can enhance people’s regard for humanity and inspire them to bring more goodness into the world, showing benefits extend from individuals to community and society."
  "38": "Paragraph A mentions a recent study where participants consistently underestimated how surprised and happy recipients of thank-you notes would feel, aligning with the statement."
  "39": "Paragraph I points out that acts of kindness can foster discomfort, such as when people feel unworthy or suspect ulterior motives, or when they feel indebted, which matches the statement."
  "40": "Paragraph F states that the benefits of gratitude are not only physical and psychological but also moral, as those who practice gratitude view life less materialistically and suffer less envy, aligning with the statement."
  "41": "Paragraph K quotes basketball coach John Wooden saying that a perfect day requires doing something for someone who can never repay you, promoting generous acts without expectation of reward, matching the statement."
  "42": "Paragraph D mentions that there is mounting evidence that counting our blessings is one of the best habits to promote mental and physical health, which matches the statement."
  "43": "Paragraph M clearly states that gratitude is one of the healthiest and most nourishing of all states of mind, aligning with the statement."
  "44": "Paragraph B says that while research into gratitude is relatively new, the principles involved are anything but (i.e., not new at all), matching the statement."
  "45": "Paragraph H states that gratitude tends to strengthen a sense of connection with others, aligning with the statement."
```
