...
questions:
  - id: "46"
    prompt: "Why do some people advocate forgiving student loan debt?"
    options:
    ...
    answer: "B"
    explanation: "The opening sentence states that some people assert forgiving student loan debt is a way to \"stimulate the economy and give assistance to those in need,\" which aligns with benefiting the economy and the underprivileged (option B). Option A is not mentioned; Option C overstates \"eliminate\" while the text says \"assistance to those in need\"; Option D is not the reason given."

  - id: "47"
    prompt: "What do we learn from the Federal Reserve data?"
    options:
    ...
    answer: "B"
    explanation: "Federal Reserve data shows the highest-income 40% of households owe ~60% of student debt, meaning debt cancellation would primarily benefit wealthy families (option B). Option A misinterprets the data; Option C is the opposite of the author’s point; Option D is contradicted by the data."

  - id: "48"
    prompt: "What does the author say students are likely to do if they know they needn’t repay their loans?"
    options:
    ...
    answer: "A"
    explanation: "The author states students will feel comfortable taking on large debt to major in \"impractical or idealistic subjects\" if loans are forgiven, meaning they will choose subjects without regard to job prospects (option A). Option C is not directly stated; Options B and D are not the author’s concern."

  - id: "49"
    prompt: "What does the author imply about colleges offering online education?"
    options:
    ...
    answer: "C"
    explanation: "The author argues students pay high tuition for \"below-average service\" (online lectures at home), implying the tuition is not justified by the quality of education (option C). Option A is a rhetorical question, not an implication; Option B is not mentioned; Option D is not stated—tuition is already seen as outrageous for the service provided."

  - id: "50"
    prompt: "What will happen if any of the proposed student debt plans is implemented?"
    options:
    ...
    answer: "C"
    explanation: "The author states working-class Americans (like plumbers and retail workers) who didn’t attend college will subsidize the education of the professional class (doctors, lawyers), meaning blue-collar workers bear the cost of educating future high-earners (option C). Options A, B, D are not supported by the text."
```
