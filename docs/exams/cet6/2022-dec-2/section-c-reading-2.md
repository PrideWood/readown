...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2022-dec-2 Section C Reading 2"
sectionId: "cet6-2022-dec-2-section-c-reading-2"
interactive: true
---
# CET-6 2022-dec-2 Section C Reading 2
...
questions:
  - id: "51"
    prompt: "What do we learn about the “No screens under 2” rule?"
    options:
    ...
    answer: "D"
    explanation: "The text states the rule “has been thrown out the window” and the AAP revised guidelines to reflect new research, meaning the rule was discarded based on recent findings (option D). Options A, B, C are not mentioned."

  - id: "52"
    prompt: "What do the new AAP guidelines advocate?"
    options:
    ...
    answer: "A"
    explanation: "The new guidelines shift focus to who is in the room, specify that toddlers can learn from media only if parents watch alongside them, and recommend co-viewing for preschoolers, advocating parental accompaniment during screen time (option A). Options B, C, D are not the core advocacy of the new guidelines."

  - id: "53"
    prompt: "What do families think of live video chat according to surveys?"
    options:
    ...
    answer: "A"
    explanation: "Surveys show families believe “Face time doesn’t count” as screen time, or that its benefits outweigh risks, meaning they do not see it as regular screen time (option A). Options B, C, D are not supported by the survey findings."

  - id: "54"
    prompt: "What do researches find about kids solo viewing educational videos?"
    options:
    ...
    answer: "C"
    explanation: "Studies show solo viewing of educational videos correlates with poorer language skills and language delays, meaning it hinders language skill development (option C). Options A, B, D are contradicted by the research findings."

  - id: "55"
    prompt: "What does the author say about preschoolers ages 2 to 5?"
    options:
    ...
    answer: "D"
    explanation: "The author states preschoolers “have the ability to transfer knowledge from screens to the real world” and AAP recommends helping them apply what they learn to the world around them, meaning they can connect screen learning to real life (option D). Option A is not stated; Option B is contradicted by the need for co-viewing; Option C is not mentioned."
```
