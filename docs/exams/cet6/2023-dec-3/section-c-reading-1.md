...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2023-dec-3 Section C Reading 1"
sectionId: "cet6-2023-dec-3-section-c-reading-1"
interactive: true
---
# CET-6 2023-dec-3 Section C Reading 1
...
questions:
  - id: "46"
    prompt: "How can research serve its full purpose according to the author?"
    options:
    ...
    answer: "D"
    explanation: "The author states research results must leave labs and journals and be effectively communicated to the public to serve its full purpose."

  - id: "47"
    prompt: "Why do ordinary readers find it difficult to access the results of researchers’ studies?"
    options:
    ...
    answer: "A"
    explanation: "Even free articles are written in academic language that is \"incomprehensible to the average reader.\""

  - id: "48"
    prompt: "What is one of the reasons some researchers won’t prioritise communicating their findings to the public?"
    options:
    ...
    answer: "B"
    explanation: "Tenure-track researchers’ main goal is winning tenure via journal publications, so public outreach is not prioritised."

  - id: "49"
    prompt: "How can sharing findings benefit researchers themselves?"
    options:
    ...
    answer: "A"
    explanation: "Engaging with the public leads to new connections and ideas that suggest \"fruitful new directions for research.\""

  - id: "50"
    prompt: "Why are researchers advised to engage the services of professional writers or communication officers?"
    options:
    ...
    answer: "C"
    explanation: "These professionals help translate technical language into accessible language to avoid public misunderstanding of findings."
```
