...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2025-june-2 Section C Reading 1"
sectionId: "cet6-2025-june-2-section-c-reading-1"
interactive: true
---
# CET-6 2025-june-2 Section C Reading 1
...
questions:
  - id: "46"
    prompt: "What gives rise to our worry about careers apart from money?"
    options:
    ...
    answer: "A"
    explanation: "The passage states that career worry has a psychological aspect: “We worry because we suspect — not wrongly — that the world is full of a frightening sort of person ready to judge us ruthlessly and swiftly: a person we can call a snob.” This directly corresponds to “Fear of being judged in a snobbish manner” in option A. Options B, C, D are not mentioned in the passage as causes of career worry."

  - id: "47"
    prompt: "What do we learn from the passage about today's snobs?"
    options:
    ...
    answer: "C"
    explanation: "The passage specifies that “Nowadays, the snob cares about one thing only: what you do for a living.” “What you do for a living” is equivalent to “occupation,” so option C is correct. Option A is about past snobbery (ancestry), not today’s. Option B is a general trait of snobs, but the question asks about *today’s* snobs, so the specific focus on occupation is more accurate. Option D is not mentioned."

  - id: "48"
    prompt: "What does the author say about people's interest in material goods?"
    options:
    ...
    answer: "D"
    explanation: "The author states, “A lot of our interest in fancy cars, jobs and houses has nothing to do with materialism. It has to do with a hunger for the respect and esteem that is only available in our societies through the acquisition of material goods.” “Hunger for the respect and esteem” matches “craving for social recognition” in option D. Option A is contradicted; the author says we shouldn’t condemn people for greed. Option B is incorrect; the interest is not about comfort. Option C misinterprets the author’s call for pity, which is not from the wealthy."

  - id: "49"
    prompt: "What kind of people do snobs deem worth respect and esteem?"
    options:
    ...
    answer: "A"
    explanation: "The passage says, “For snobs, it is the already acclaimed and already successful who are the only ones worthy of respect.” “Already acclaimed and already successful” corresponds to “fame and fortune” in option A. Option B describes snobs’ own minds, not those they respect. Options C and D are qualities snobs fail to recognize, not the ones they value."

  - id: "50"
    prompt: "What does the author imply we should do to avoid being snobbish?"
    options:
    ...
    answer: "B"
    explanation: "The author concludes, “our ultimate duty remains to be kind, good curious and imaginative about pretty much everyone who ever crosses our path.” This directly matches option B. Option A is incorrect; the author says the answer is not to deny better or worse people exist. Option C is a premise, not the recommended action. Option D is not mentioned; the author warns against judging by outward signs."
```
