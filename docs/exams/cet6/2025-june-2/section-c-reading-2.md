...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2025-june-2 Section C Reading 2"
sectionId: "cet6-2025-june-2-section-c-reading-2"
interactive: true
---
# CET-6 2025-june-2 Section C Reading 2
...
questions:
  - id: "51"
    prompt: "What do we learn about the gender pay gap in the US during the 1980s?"
    options:
    ...
    answer: "B"
    explanation: "The passage states that in the 1980s, women “began to catch up — fast” and the gender pay gap “closed by about one percentage point a year.” “Fast” and the annual closing rate indicate the gap was shrinking rapidly, matching option B. Option A’s “slowly” contradicts “fast.” Option C describes the current gap, not the 1980s trend. Option D is not the focus of the 1980s description."

  - id: "52"
    prompt: "What happened with the introduction of state and federal family leave policies?"
    options:
    ...
    answer: "B"
    explanation: "The passage notes that after family leave policies were introduced, “the rate of gender wage convergence fell to just 0.03 percentage points per year” from the previous 1 percentage point per year. This shows a noticeable fall in the convergence rate, matching option B. Option A refers to pandemic-era reversal, not the immediate effect of leave policies. Option C is incorrect; the policies helped women stay in work, not start a return trend. Option D is not mentioned."

  - id: "53"
    prompt: "What partly accounts for the slip in women’s salaries?"
    options:
    ...
    answer: "C"
    explanation: "The passage states, “Part of this is because women take on more of the unpaid labor at home, which can eat into time available for work and energy for career advancement.” “Unpaid labor at home” corresponds to “taking care of the family,” and the resulting loss of time and energy matches option C. Option A is not mentioned. Option B is a result, not a cause. Option D is incorrect; the passage notes time off is supported by policy."

  - id: "54"
    prompt: "What does the new study say about wage parity?"
    options:
    ...
    answer: "D"
    explanation: "The study states, “if the 1980s trend continued, we would have been at parity by now.” “At parity” means wage parity would have been attained, matching option D. Option A is a speculative point, not the study’s direct claim. Option B is not mentioned. Option C is not stated; the passage mentions bias was addressed but does not link full erasure to parity."

  - id: "55"
    prompt: "What prevents women from achieving parity with men in the final analysis?"
    options:
    ...
    answer: "B"
    explanation: "The passage concludes that even if bias was addressed, women “are the ones to bear children and take care of them in the early weeks because of biological factors... forcing them to take breaks.” This biological and caregiving role is the final barrier to parity, matching option B. Option A is a past issue, not the final analysis. Option C is incorrect; breaks are mandated or not, but the biological need remains. Option D is not mentioned."
```
