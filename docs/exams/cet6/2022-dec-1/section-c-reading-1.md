...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2022-dec-1 Section C Reading 1"
sectionId: "cet6-2022-dec-1-section-c-reading-1"
interactive: true
---
# CET-6 2022-dec-1 Section C Reading 1
...
questions:
  - id: "46"
    prompt: "What does the author say about the pursuit of work-related self-esteem?"
    options:
    ...
    answer: "A"
    explanation: "The author states that repeating work accomplishments to boost self-esteem is often unrealistic, leading to negative emotional consequences and a \"negative type of motivation\" that hinders more positive forms of motivation (option A). Options B, C are not the author’s core point; Option D is an overstatement, as the pursuit also has positive outcomes."

  - id: "47"
    prompt: "What do employees tend to do in pursuing work-related self-esteem?"
    options:
    ...
    answer: "B"
    explanation: "Employees extend themselves to avoid shame and failure, which has an \"adverse effect on their well-being,\" meaning they strive to succeed at the cost of their own well-being (option B). Option A is not mentioned; Option C is extreme; Option D is the feeling they avoid, not something they exaggerate."

  - id: "48"
    prompt: "What do we learn about people over-concerned with work-related self-esteem?"
    options:
    ...
    answer: "B"
    explanation: "The negative emotions from this pursuit impact their ability to \"make the most of their personal life,\" leaving them with diminished capacity for friendship and leisure (option B). Options A, C, D are not supported by the text."

  - id: "49"
    prompt: "What is the good news we learn from the recent research?"
    options:
    ...
    answer: "A"
    explanation: "The study found that employees are also motivated by the excitement of pursuing emotional rewards, which makes goal pursuit \"enjoyable and stimulates pleasure and pride\" (option A). Option B is not stated; Option C is incorrect as negative consequences still exist; Option D is refuted by the text."
  ...
  - id: "50"
    ...
    answer: "D"
    explanation: "The last paragraph states that how people feel about their work has less to do with self-esteem preservation and \"more with the fact that they’re simply motivated,\" implying that being motivated leads to positive feelings about work (option D). Option A is a side effect, not the inference; Option B is not mentioned; Option C is a stated fact, not an inference."
```
