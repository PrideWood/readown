...
questions:
  - id: "46"
    prompt: "What has been a standard piece of dietary advice for decades?"
    options:
    ...
    answer: "A"
    explanation: "The first sentence states that the suggestion to aim for dietary diversity (eat a variety of foods) has been a standard public health recommendation for decades."

  - id: "47"
    prompt: "What did the new research by the American Heart Association find?"
    options:
    ...
    answer: "C"
    explanation: "The study found a correlation between dietary diversity and greater calorie intake, as well as higher obesity prevalence, meaning those seeking diversity tend to eat more."

  - id: "48"
    prompt: "What could help to explain the contradiction between the new findings and the common public health recommendation?"
    options:
    ...
    answer: "A"
    explanation: "The text notes that \"dietary diversity\" is not clearly or consistently defined, with little agreement on its meaning, which explains the contradiction."

  - id: "49"
    prompt: "What did Dr. Rao find after 20 years of research on obesity?"
    options:
    ...
    answer: "B"
    explanation: "Dr. Rao observed that people with regimented diets are healthier than those with diverse intake, aligning with the study’s finding that diversity is not linked to healthy weight."

  - id: "50"
    prompt: "What does the passage say about people who eat a great variety of food?"
    options:
    ...
    answer: "C"
    explanation: "The passage states that more food variety may delay fullness, leading people to eat more until they overeat."
```
