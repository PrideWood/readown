...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2023-mar-1 Section C Reading 2"
sectionId: "cet6-2023-mar-1-section-c-reading-2"
interactive: true
---
# CET-6 2023-mar-1 Section C Reading 2
...
questions:
  - id: "51"
    prompt: "In what way were humans thought to be unique?"
    options:
    ...
    answer: "A"
    explanation: "The first sentence states that the ability to make inferences from same and different (same-different discrimination) was once thought to be unique to humans."

  - id: "52"
    prompt: "What do we learn from the study published in Science?"
    options:
    ...
    answer: "D"
    explanation: "The study challenges the idea of \"birdbrain\" and shows newborn ducklings have abstract thinking ability, proving our prior view of bird intelligence was wrong."

  - id: "53"
    prompt: "What did the researchers discover about most ducklings from their experiment?"
    options:
    ...
    answer: "B"
    explanation: "70% of ducklings chose objects with the same shape/color relationship as the first pair, showing they could discern same vs. different."

  - id: "54"
    prompt: "What was novel about the experiment in the study reported in Science?"
    options:
    ...
    answer: "C"
    explanation: "Previous studies required extensive training, but this study used untrained newborn ducklings, which is novel."

  - id: "55"
    prompt: "What do we learn from Dr. Wasserman’s comment on the study of animal minds at the end of the passage?"
    options:
    ...
    answer: "D"
    explanation: "Dr. Wasserman says we are in a \"revolutionary phase\" of understanding animal minds, indicating remarkable progress."
```
