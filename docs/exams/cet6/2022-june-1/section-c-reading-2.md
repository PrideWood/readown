...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2022-june-1 Section C Reading 2"
sectionId: "cet6-2022-june-1-section-c-reading-2"
interactive: true
---
# CET-6 2022-june-1 Section C Reading 2
...
questions:
  - id: "51"
    prompt: "What does the author intend to show by citing the findings from the report published last year?"
    options:
    ...
    answer: "A"
    explanation: "The report shows 36% of Australians cited \"common sense\" for denying climate change, while only 11% based it on scientific research, illustrating that people often rely on subjective \"common sense\" rather than rational, evidence-based thinking (option A). Options B, C, D are not the intended message of the cited report."

  - id: "52"
    prompt: "What is the appeal to common sense according to the author?"
    options:
      A: "It is the basis for the internalization of individuals’ ideologies."
    ...
    answer: "D"
    explanation: "The author states that an appeal to common sense is \"usually nothing more than an appeal to thinking that just feels right,\" which is subjective and varies between individuals (option D). Option A reverses the causal relationship; option B contradicts the text, as common sense is not based on complex reasoning; option C misrepresents its role."

  - id: "53"
    prompt: "What does Daniel Kahneman think is the problem of testing new ideas with existing beliefs?"
    options:
    ...
    answer: "A"
    explanation: "Kahneman notes that when we judge new ideas by compatibility with existing beliefs, the outcomes \"feel true, regardless of whether they are,\" meaning this method can lead to wrong judgments (option A). Options B, C, D are not supported by the text."

  - id: "54"
    prompt: "What can we do to be less susceptible to cognitive biases?"
    options:
    ...
    answer: "C"
    explanation: "The author proposes that \"social verification of knowledge\" (socially shared cognition) through rigorous, systematic methods like science can check internal biases (option C). Options A, B, D are not mentioned as solutions to cognitive biases."
  ...
  - id: "55"
    ...
    options:
      ...
      D: "Collaborative efforts can overcome individual’s limitations in scientific inquiry."
    answer: "D"
    explanation: "The author concludes that \"we are smarter together than we are individually,\" emphasizing that collaborative, systematic inquiry (like science) can overcome the limitations of individual thinking and common sense (option D). Option A is not mentioned; Option B is too vague; Option C contradicts the author’s emphasis on collaboration."
```
