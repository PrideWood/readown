...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2023-dec-2 Section C Reading 2"
sectionId: "cet6-2023-dec-2-section-c-reading-2"
interactive: true
---
# CET-6 2023-dec-2 Section C Reading 2
...
questions:
  - id: "51"
    prompt: "What does the author think is easy to see in many areas of contemporary life?"
    options:
    ...
    answer: "D"
    explanation: "The first paragraph states we cannot but recognize \"the effect competition is exerting\" in academics and other areas of modern life."

  - id: "52"
    prompt: "According to psychology, what do people strive to do following the initial stage of their life?"
    options:
    ...
    answer: "D"
    explanation: "After the initial stage, people balance \"base impulses for self-fulfillment\" with \"social and cultural norms which prohibit pure indulgence,\" meaning they satisfy their own desires while following social conventions."

  - id: "53"
    prompt: "What do we learn about the “natural world” characterized by Thomas Hobbes?"
    options:
    ...
    answer: "C"
    explanation: "Hobbes defined the \"natural world\" as the world \"before the imposition of the will of humanity,\" i.e., free from human rational intervention."

  - id: "54"
    prompt: "What can we conclude from Darwin’s assertion in The Origin of Species?"
    options:
    ...
    answer: "B"
    explanation: "Darwin said struggles for survival should be seen as metaphors and \"could easily include dependence and cooperation,\" meaning survival struggles do not exclude mutual support."

  - id: "55"
    prompt: "What conclusion did Margaret Mead reach after studying dozens of different cultures?"
    options:
    ...
    answer: "D"
    explanation: "Mead concluded competitiveness is a \"culturally created aspect of human behavior\" and its prevalence depends on how a society values it, i.e., attitudes toward competition are culture-bound."
```
