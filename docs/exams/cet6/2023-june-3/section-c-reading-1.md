...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2023-june-3 Section C Reading 1"
sectionId: "cet6-2023-june-3-section-c-reading-1"
interactive: true
---
# CET-6 2023-june-3 Section C Reading 1
...
questions:
  - id: "46"
    prompt: "In what way does Michael Moss think processed food is comparable to alcohol and cigarettes?"
    options:
    ...
    answer: "A"
    explanation: "Moss states processed food is \"engineered to hook you, not unlike alcohol, cigarettes,\" meaning they are all addictive."

  - id: "47"
    prompt: "What does the author say plays a key role in the foods we crave?"
    options:
      ...
      D: "Memory."
    answer: "D"
    explanation: "The author explicitly says \"Memory, nostalgia in particular, plays a big role in the foods we crave.\""

  - id: "48"
    prompt: "What do food companies do to capitalize on consumers’ association with their food products?"
    options:
    ...
    answer: "A"
    explanation: "Food companies \"spend lots of time trying to shape the memories that we have for their products\" to keep consumers snacking."

  - id: "49"
    prompt: "How does the food industry operate from manufacturing to packaging, according to Moss?"
    options:
    ...
    answer: "C"
    explanation: "Moss notes \"Everything in the industry is about speed, from manufacturing to packaging.\""

  - id: "50"
    prompt: "Why are companies finding it difficult to satisfy consumers’ demand for healthier food products?"
    options:
    ...
    answer: "D"
    explanation: "Companies are \"addicted to making these convenience foods,\" making it hard to shift to healthier options."
```
