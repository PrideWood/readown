...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2023-june-3 Section C Reading 2"
sectionId: "cet6-2023-june-3-section-c-reading-2"
interactive: true
---
# CET-6 2023-june-3 Section C Reading 2
...
questions:
  - id: "51"
    prompt: "What might explain humans’ having the largest population of almost all mammals?"
    options:
    ...
    answer: "C"
    explanation: "The initial explanation is that our big brains and raw intelligence allowed innovative problem-solving, leading to global colonization and large population."

  - id: "52"
    prompt: "What accounts for humans’ evolutionary successes according to a growing number of cognitive scientists and anthropologists?"
    options:
    ...
    answer: "D"
    explanation: "These scientists argue humans survive by carefully copying others, not by innovating on their own."

  - id: "53"
    prompt: "What does the author think is odd about the findings of the study by Victoria Horner and Andrew Whiten?"
    options:
    ...
    answer: "A"
    explanation: "The author finds it odd that children copied all steps (including useless tapping) even when they could see the stick had no effect, acting irrationally."

  - id: "54"
    prompt: "What is anthropologist Joseph Henrich’s explanation for the human preference for copying?"
    options:
    ...
    answer: "B"
    explanation: "Henrich explains that complex technologies require step-by-step learning by imitating experienced others, as rational learning alone is impossible."

  - id: "55"
    prompt: "What point does the author want to emphasize when he says “We’re not chimpanzees”?"
    options:
    ...
    answer: "B"
    explanation: "The author uses the contrast with chimpanzees (who imitate rationally) to highlight that mindless imitation is a uniquely human trait, part of our evolutionary success."
```
