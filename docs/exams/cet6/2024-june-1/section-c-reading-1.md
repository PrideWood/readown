...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2024-june-1 Section C Reading 1"
sectionId: "cet6-2024-june-1-section-c-reading-1"
interactive: true
---
# CET-6 2024-june-1 Section C Reading 1
...
questions:
  - id: "46"
    prompt: "What is one of the factors contributing to failure of intervention in face of risky behavior in the workplace?"
    options:
    ...
    answer: "B"
    explanation: "The passage lists three factors for intervention failure: inability to see risk, company culture not making people feel safe to speak up, and lack of communication skills. \"Company's culture needs to make them feel safe to speak up\" directly corresponds to \"unfavorable workplace culture\" in option B. Option A, C, D are not mentioned as contributing factors."

  - id: "47"
    prompt: "What does the author mean by \"diffusion of responsibility\" (Para.3)?"
    options:
    ...
    answer: "D"
    explanation: "The passage defines diffusion of responsibility as: \"the larger the crowd, the more people assume that someone else will take care of it—meaning no one effectively intervenes.\" This matches \"the more people are around, the less chance someone will step forward to intervene\" in option D. Option B uses \"participate\" which is less precise than \"intervene.\""

  - id: "48"
    prompt: "What happens when unsafe behavior at the workplace is not addressed by the leaders?"
    options:
    ...
    answer: "A"
    explanation: "The passage states that when leaders don't address unsafe behavior, it \"creates the precedent that this is how these situations should be addressed,\" defining the safety culture. This precedent leads to no one intervening in similar behaviors, matching option A. Options B, C, D are not mentioned."

  - id: "49"
    prompt: "What is the ultimate reason workers won't act when they see unsafe operations?"
    options:
    ...
    answer: "D"
    explanation: "The passage explicitly says, \"Fear is the ultimate factor in not intervening. There is a fear of penalty, a fear that they'll have to do more work if they intervene.\" \"Fear of having to do more work\" is directly listed as part of the ultimate fear, matching option D. Option A is a result of past unsuccessful attempts, not the ultimate reason."

  - id: "50"
    prompt: "What is critical to ensuring workplace safety?"
    options:
    ...
    answer: "C"
    explanation: "The passage states supervisors \"need a broad set of skills to... build a safety climate within their team that supports intervening and open communication.\" This \"safety climate\" matches \"create a safety environment for timely intervention\" in option C. Option D is part of the skill set, but the broader goal is building the safety environment."
```
