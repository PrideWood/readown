...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2024-june-2 Section C Reading 2"
sectionId: "cet6-2024-june-2-section-c-reading-2"
interactive: true
---
# CET-6 2024-june-2 Section C Reading 2
...
questions:
  - id: "51"
    prompt: "What do we learn from the passage about one's loss of a job?"
    options:
    ...
    answer: "C"
    explanation: "The passage states that losing a job “provokes an identity crisis much greater than the loss of the job itself” and people often say “Without my job I don't know who I am.” This means job loss makes people confused about their identity, matching option C."

  - id: "52"
    prompt: "What has the author come to understand about our identity?"
    options:
    ...
    answer: "D"
    explanation: "The author explicitly says, “our identity is much more complex than we recognise at first glance.” “More complex” matches “more complicated than it appears” in option D."

  - id: "53"
    prompt: "What does the passage say about our identities at work?"
    options:
    ...
    answer: "B"
    explanation: "The passage notes, “our identities at work are not static. They change over time.” “Change over time” matches “evolve with the passage of time” in option B."

  - id: "54"
    prompt: "What do we have to do in today's ever-changing job market?"
    options:
    ...
    answer: "D"
    explanation: "The passage states, “we have to manage uncertainty, especially in today's volatile and ever-shifting job market.” This directly matches option D."

  - id: "55"
    prompt: "What should we do to expand our career options?"
    options:
    ...
    answer: "A"
    explanation: "The passage says to “explore whether you can create a new experience of your identity by changing the beliefs you hold about yourself in order to expand your career options.” “Changing the beliefs you hold about yourself” matches “alter our perceptions of ourselves” in option A."
```
