...
type: "cloze"
part: "section-a"
title: "CET-6 2023-june-1 Section A Cloze"
sectionId: "cet6-2023-june-1-section-a-cloze"
interactive: true
---

# CET-6 2023-june-1 Section A Cloze
...
26:解析：does not surpass other intelligent animals意为“并未超越其他高智商动物”，surpass（超越）符合“狗的智力在各类别中不占优势”的结论，故选N。
27:解析：a significant body of research has examined dog cognition previously意为“此前已有大量研究探讨狗的认知”，previously（此前）符合新研究与旧研究的对比，故选K。
28:解析：warrant the volume of work意为“证明如此大量的研究是合理的”，volume（数量、体量）描述研究投入的规模，故选O。
29:解析：designed their studies to prove how clever dogs are意为“设计研究来证明狗有多聪明”，prove（证明）符合部分研究者的主观倾向，故选M。
30:解析：These comparisons affirmed that...意为“这些比较证实了……”，affirmed（证实）符合研究结论的表达，故选A。
31:解析：not as formidable as some researchers might have believed意为“不如一些研究者认为的那样强大”，formidable（强大的、令人惊叹的）符合对狗智力的修正认知，故选G。
32:解析：recognize and differentiate human voices意为“识别并区分人类声音”，differentiate（区分）符合猫狗对人声的感知能力，故选D。
33:解析：a greater number of distinct human voices意为“更多不同的人类声音”，distinct（不同的、独特的）用于描述声音的个体差异，故选E。
34:解析：not all researchers agree completely with the findings意为“并非所有研究者都完全认同这些发现”，completely（完全地）修饰同意的程度，故选C。
35:解析：overstated the idea that...意为“夸大了……的观点”，overstated（夸大）符合Zachary Silver对新研究的批评，故选I。
