...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2023-june-2 Section C Reading 1"
sectionId: "cet6-2023-june-2-section-c-reading-1"
interactive: true
---

# CET-6 2023-june-2 Section C Reading 1
...
### 46
Prompt: Which group of people does the author say has almost unrestricted access to children?
- A. Advertisers.
- B. Carers.
- C. Teachers.
- D. Doctors.
...
Answer: A
Explanation: The author states advertisers/marketers have almost unconstrained access to children, unlike other groups who are scrutinized.

### 47
Prompt: What kind of people should we enable children to become according to the author?
...
Answer: B
Explanation: The author wants children to become "young citizens who will value themselves for what they contribute to the society".

### 48
Prompt: Many child development experts and educators call attention to research that suggests __________.
...
Answer: A
Explanation: Research cited by experts suggests cradle-to-grave (lifelong) consumerism contributes to low self-esteem, depression and other mental illnesses.

### 49
Prompt: What does the author imply about the impact of advertising?
...
Answer: A
Explanation: The author mentions advertisements have a "viral effect"—infecting a few to reach many, meaning it spreads widely.

### 50
Prompt: What is the opponents’ argument against a complete ban on advertising to young children?
...
Answer: D
Explanation: Opponents argue a ban would breach freedom of speech and infringe corporations’ rights to market to children.