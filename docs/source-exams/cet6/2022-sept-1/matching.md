...
type: "matching"
part: "section-b"
title: "CET-6 2022-sept-1 Section B Matching"
sectionId: "cet6-2022-sept-1-section-b-matching"
interactive: true
---

# CET-6 2022-sept-1 Section B Matching

## Passage Title
Passage Title: Is computer coding a foreign language?

## Paragraphs

### A
As computer coding has become an increasingly sought-after skill, more K-12 schools are working it into their curriculums. Some states have considered allowing students to forgo (放弃) foreign language for coding classes, despite opposition from educators.
...
Answer: L
Explanation: Paragraph L states “recruiters and employers value computer skills more… 55 percent of employers looked for computer skills on applicants’ resumes, while study abroad and foreign language fluency were not very influential,” matching the statement.
...
Answer: E
Explanation: Paragraph E quotes Florida Senator Jeremy Ring introducing a bill that would let students choose between foreign language and coding classes, matching the statement.
...
Answer: K
Explanation: Paragraph K quotes Ted Zarrow saying learning languages helps “put ourselves at the global table and to treat each other with mutual respect,” matching the statement.

### 39
Statement: One U.S. state will see to it that programming classes are taught by quality teachers.
Answer: G
Explanation: Paragraph G states Kentucky “will provide support for higher quality certified teachers for programming classes,” matching the statement.
...
Answer: D
Explanation: Paragraph D notes computer science jobs are growing, while foreign language enrollments have declined since 1995 (mid-1990s), matching the statement.

### 41
Statement: All school subjects are said to be essential to students’ well-rounded development.
Answer: H
Explanation: Paragraph H says “every subject, whether art, math or language, is a significant contribution to a well-rounded existence,” matching the statement.
...
Answer: B
Explanation: Paragraph B states “most educators agree: Coding should be added to curriculums, but not at the expense of foreign language classes,” matching the statement.

### 43
Statement: One study showed that foreign language learning improved students’ academic performance.
Answer: J
Explanation: Paragraph J cites a 2007 study showing foreign language students “outperformed their non-foreign language peers on standardized tests,” matching the statement.

### 44
Statement: Being short of funding and qualified teachers, schools lag behind the fast developing computer science field.
Answer: C
Explanation: Paragraph C says the computer science field is growing faster than schools can keep up “because of budget constraints and a lack of skills training for teachers,” matching the statement.
...
Answer: N
Explanation: Paragraph N states “Zarrow agrees that foreign language education should begin earlier,” matching the statement.