...
## Passage Title
Passage Title: The Doctor Will Skype You Now
...
Answer: E
Explanation: Paragraph E states that mothers complain children refuse meals because they are fed cheap packaged chips (junk food), which matches the statement.
...
Answer: B
Explanation: Paragraph B notes “while child mortality and maternal death have gone down in the rest of the country, this is not the case for the islands,” meaning maternal death (women dying in childbirth) remains high on the islands, matching the statement.
...
Answer: J
Explanation: Paragraph J says the organization offers discounts on medicines, but “still many residents can’t afford even that,” matching the statement.

### 39
Statement: TD is a virtual medical service financially supported by one of the nation’s nonprofit organizations.
Answer: D
Explanation: Paragraph D states TD “is funded by a nonprofit organization founded by Bangladeshi entrepreneurs, finance and technology professionals,” matching the statement.

### 40
Statement: TD doctors are welcome to the islanders because they treat the sick with respect and patience.
Answer: K
Explanation: Paragraph K quotes a resident saying “Dr. Apa is patient… here they listen to us,” contrasting with poor treatment at government hospitals, matching the statement.

### 41
Statement: Women islanders tend to have health problems early partly because they get married and give birth early.
Answer: F
Explanation: Paragraph F states “Early marriage and young motherhood… also contribute to the early onset of health problems” for rural women, matching the statement.

### 42
Statement: TD doctors make weekly visits to the remote islands to provide services at a temporary medical center.
Answer: C
Explanation: Paragraph C says “Every week, TD’s medical operators travel to the islands by boat… and set up a makeshift (temporary) medical center,” matching the statement.

### 43
Statement: TD doctors provide the islanders with online diagnoses and treatments for common diseases.
Answer: G
Explanation: Paragraph G states TD doctors “can write prescriptions, diagnose common ailments… and refer patients to doctors at local hospitals” via live-streamed consultations, matching the statement.

### 44
Statement: The residents of the river islands have to keep moving their homes because of floods and land erosions.
Answer: A
Explanation: Paragraph A says island residents “face repeated displacement from flooding and erosion,” meaning they have to move their homes repeatedly, matching the statement.
...
Answer: H
Explanation: Paragraph H states women describe their illness to husbands, who then go to the pharmacy and return with “some random medicines” (without proper diagnosis/prescription), matching the statement.