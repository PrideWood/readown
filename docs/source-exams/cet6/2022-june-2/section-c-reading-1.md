...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2022-june-2 Section C Reading 1"
sectionId: "cet6-2022-june-2-section-c-reading-1"
interactive: true
---

# CET-6 2022-june-2 Section C Reading 1
...
In Taryn’s case, AI software enabled her to communicate melodies and chords that she didn’t know how to put together herself. The end product was therefore a collaborative effort, rather than a piece entirely produced by technology. Taryn’s story has a distinctly positive feel that highlights the advantages of using AI in music production. It can serve as a source of inspiration, and BS an ideal jumping-off point should a musician be hit with writer’s block (文思枯竭).
...
### 46
Prompt: How do some musicians perceive using AI in creating music?
...
Answer: B
Explanation: The text states that "some musicians consider it to be hugely detrimental to the music scene" when referring to using AI in music creation, which directly matches option B. Option A is not mentioned; Option C is not the core perception of these musicians; Option D is a view held by those who see AI as a helpful tool, not the critical group.

### 47
Prompt: What does Taryn Southern’s story illustrate?
...
Answer: A
Explanation: Taryn’s story shows that AI software helped her create melodies and chords she couldn’t put together herself, serving as a source of inspiration and a jumping-off point for her work, illustrating that AI is beneficial (conducive) to music composition (option A). Options B and D are extreme claims not supported by the text; Option C is a side point, not the main illustration of her story.

### 48
Prompt: Why are some musicians opposed to the use of AI in creating music?
...
Answer: A
Explanation: Opposing musicians argue that "a computer could never emulate the work (and human touch) of a true musician," meaning AI music lacks the human element (humanness) (option A). Option B is the opposite of their argument; Options C and D are not mentioned in the text.

### 49
Prompt: Why do many people think music is too precious to impart to AI technology?
...
Answer: D
Explanation: The text states that "many people see music as such an inherently human expression," meaning it is uniquely human (human specific), hence too precious to be given to AI (option D). Options A and B are related to the perception of AI-generated music, not the core reason people value music; Option C is too general compared to "inherently human expression."

### 50
Prompt: What does the author think of the future of AI music?
...
Answer: B
Explanation: The author concludes that "it’s only a matter of time before AI-produced music is seen as the new norm," indicating that AI music will become the standard (norm) in the future (option B). Option A is a supporting detail, not the author’s main view on its future; Option C is not guaranteed; Option D is not mentioned.