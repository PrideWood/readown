...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2025-june-1 Section C Reading 1"
sectionId: "cet6-2025-june-1-section-c-reading-1"
interactive: true
---

# CET-6 2025-june-1 Section C Reading 1
...
### 46
Prompt: What does the U.S. secretary of education say in his open letter?
...
Answer: C
Explanation: The passage states that the secretary’s open letter “stated that missing 10% of school days in a year for any reason — excused or unexcused — is a primary cause of low academic achievement.” “Primary cause” aligns with “mainly attributed to” in option C. Option A is not mentioned; the letter urges support, not prompt response. Option B confuses “deplored missed instruction” with “deplorable academic performance.” Option D is a general worry, not the specific claim in the letter.

### 47
Prompt: What do the authors find about school absences?
...
Answer: A
Explanation: The authors find “that absences excused by a parent do little to harm children’s learning.” This directly matches option A. Option B is wrong; the passage shows a clear difference in academic impact between excused and unexcused absences. Option C is incorrect; excused absences do not lead to better performance, just no harm compared to no absences. Option D is a consequence of current policies, not the authors’ finding about absences themselves.

### 48
Prompt: What do the authors believe concerning unexcused school absences?
...
Answer: B
Explanation: The authors state, “We believe unexcused absence is a strong signal of the many challenges children and families face, including economic and medical hardships.” “Strong signal of the many challenges” matches “point directly to many of the out-of-school challenges” in option B. Option A is the common misconception the authors refute; they say unexcused absences matter as a signal, not as a direct cause of lower achievement. Option C is incorrect; current policies do not ignore absences, but misinterpret them. Option D reverses the direction; the absences signal existing crises, not future ones.

### 49
Prompt: What is the assumption underlying education policies in the U.S.?
...
### 50
Prompt: What do the authors suggest doing regarding school absences?
...
Answer: C
Explanation: The authors conclude, “We instead suggest using unexcused absence from school as a signal to channel resources to the children and families who need them most.” “Channel resources to the children and families who need them most” directly matches “directing resources to helping needy children” in option C. Option A is implied but not the direct suggestion. Option B is a means to an end, not the final suggestion. Option D is what current policies do, which the authors criticize.