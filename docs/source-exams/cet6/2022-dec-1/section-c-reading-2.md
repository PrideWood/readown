...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2022-dec-1 Section C Reading 2"
sectionId: "cet6-2022-dec-1-section-c-reading-2"
interactive: true
---

# CET-6 2022-dec-1 Section C Reading 2
...
### 51
Prompt: What is the major finding of the UN environmental study?
...
Answer: B
Explanation: The first sentence of first paragraph.

### 52
Prompt: What is said about water scarcity in some of the poorest regions?
...
Answer: C
Explanation: The text states there is "little prospect of this desperate situation being remedied without radical action being taken," meaning water scarcity can hardly be fixed without drastic measures (option C). Option A is too extreme; Option B is not mentioned; Option D is not the primary cause.

### 53
Prompt: What does Achim Steiner say about the environmental condition?
...
Answer: A
Explanation: Achim Steiner warns that if current trends continue and production/consumption isn't improved, the world’s environment "will continue to decline," meaning it will deteriorate (option A). Options B, C, D are not mentioned in his statement.

### 54
Prompt: What is the dilemma developing countries face?
...
### 55
Prompt: What should developing countries do in their future development according to the passage?
...
Answer: D
Explanation: International institutions have encouraged developing countries to devise "more sustainable growth pathways that are supposed both to alleviate poverty and preserve the environment," meaning they should improve livelihoods without harming the environment (option D). Options A, B, C are not supported by the text.