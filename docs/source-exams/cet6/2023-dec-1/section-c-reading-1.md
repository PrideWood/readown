...
type: "mcq-reading"
part: "section-c"
title: "CET-6 2023-dec-1 Section C Reading 1"
sectionId: "cet6-2023-dec-1-section-c-reading-1"
interactive: true
---

# CET-6 2023-dec-1 Section C Reading 1
...
### 46
Prompt: Why does the formula of tax cuts remain popular though ineffective?
...
Answer: B
Explanation: The tax cut formula remains popular because it "lacks for obvious rivals"—no competing economic narrative has emerged to replace it.

### 47
Prompt: What does the author think is a more effective measure for driving economic growth in the U.S.?
...
Answer: C
Explanation: The author argues raising workers’ wages (compensation for labor) should be the priority to drive economic growth.

### 48
Prompt: What is the logic underlying the author’s viewpoint?
...
Answer: A
Explanation: The core logic is that higher wages lead to more consumer spending, which drives the U.S. economy (consumption drives growth).

### 49
Prompt: What is the basis for higher wages according to the conventional wisdom?
...
Answer: B
Explanation: Conventional wisdom held that productivity growth was the only legitimate route to higher wages.

### 50
Prompt: What do we learn about things in the real world in America for the past 50 years or so?
...
Answer: A
Explanation: Over the past ~50 years, productivity has doubled but wages have lagged far behind, showing no corresponding growth between wages and productivity.